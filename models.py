...
class Encoder(nn.Module):
    def __init__(self, num_heads, num_hidden_layers, num_encoders, d_model, d_hidden):
        super(Encoder, self).__init__()
        # create a module list of num_decoder DecoderBlock objects
        self.encoder_blocks = nn.ModuleList([
            EncoderBlock(d_model, num_heads, d_hidden, num_hidden_layers)
...
class ETPOL(nn.Module):
    ...
    def __init__(self, vocab_size, context_length, d_model, d_hidden, num_hidden_layers, num_heads, num_encoders):
